...
/**
 * Action class for 'popular stations' report page.
 * 
 * @author finagle
 */
public class PopularStationsReportAction extends ReportAction {
	...
	public PopularStationsReportAction() {
		super(ReportType.POPULAR_STATIONS, "text.report.popularstations.title");
	}
	...
	protected boolean validateInput() {
		...
		try {
			...
			message = getText("text.report.popularstations.error.from");
			messageType = "error";
			return false;
		}
		...
		try {
			...
			message = getText("text.report.popularstations.error.to");
			messageType = "error";
			return false;
		}
	...
	protected boolean generateReport(final String reportId) {
		PopularStationsReportGenerator generator =
			ServiceFactory.getPopularStationsReportGenerator();
